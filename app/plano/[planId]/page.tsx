    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center text-center p-8" style={{ background: '#050505', color: 'white' }}>
        ...
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-brand-success/10 border border-brand-success/20 mb-5">
          ...
          <span className="text-[9px] font-mono uppercase tracking-widest text-brand-success font-black">Checkout Aberto</span>
        </div>
        <h1 className="text-4xl font-display font-black uppercase tracking-tighter mb-3 leading-none">
          Quase lá<span className="text-brand-accent">.</span>
        </h1>
        <p className="text-white/50 font-mono text-sm max-w-xs leading-relaxed mt-4">
          Uma nova aba foi aberta com o checkout seguro.<br />
          Complete o pagamento com seu cartão de crédito para ativar sua assinatura em <span className="text-white font-black">{plan?.barbershopName}</span>.
        </p>
        <p className="text-white/20 font-mono text-[10px] mt-8 uppercase tracking-widest">Pode fechar esta aba após concluir</p>
      </div>
    );
  }
    ...
    <div className="min-h-screen text-white font-sans" style={{ background: '#050505' }}>
      ...
      <div className="relative max-w-md mx-auto px-6 py-16">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          >
            {submitting
              ? <><Loader2 size={18} className="animate-spin" /> Gerando checkout...</>
