...
import { CheckCircle2, Copy, Trash2, Edit3, XCircle, ChevronLeft, ChevronRight, TrendingUp, X, QrCode, Download, Printer } from 'lucide-react';
...
export default function AppointmentsPage() {
  ...
  const openNew = (date?: Date) => {
    ...
    router.push(`/appointments/manual?date=${dateStr}`);
  };

  const openEdit = (app: Appointment) => router.push(`/appointments/manual?id=${app.id}`);
